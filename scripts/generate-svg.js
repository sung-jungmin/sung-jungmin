...
.line{fill:#F0EEE6}.sep{fill:#E5947A}}
  ...
  p.push(`<text x="${cx}" y="68" class="line" text-anchor="middle">🛠 lowkey just commits</text>`);
  p.push(`<text x="${cx}" y="104" class="sep" text-anchor="middle">·</text>`);
  p.push(`<text x="${cx}" y="160" class="line" text-anchor="middle">🌱 highkey trying to ship</text>`);
  p.push(`<text x="${cx}" y="196" class="sep" text-anchor="middle">·</text>`);
  p.push(`<text x="${cx}" y="252" class="line" text-anchor="middle">☕ always learning fr</text>`);
